...
@NamedQuery(name = "buscarPorDevice", query = "select tvp from TransactionSpTvPagada tvp where tvp.deviceId = :deviceId")
public class TransactionSpTvPagada {
	...
	public Long getTipoD() {
		return tipoD;
	}

	public void setTipoD(Long tipoD) {
		this.tipoD = tipoD;
	}
	...
	private Integer toInt(Object objeto, String campo) throws ConversionException {
		try {
			...
			throw new ConversionException(generaMensaje("Dato vacio", campo), e);
		}
	}

	private String generaMensaje(String mensajeError, String campo) {
		StringBuffer returnValue = new StringBuffer(80);
