...
public class InternetSGRBean implements InternetSGR {
	...
	private Respuesta creacion (Aprovisionamiento_Type parametros){
		...
		if (equipoexistente.equals("OK")){
			...
			respuesta = CreacionEquiposInt(parametros, resp, idcontroller);
	...
	private Respuesta CreacionEquiposInt (Aprovisionamiento_Type parametros, Respuesta respuesta, int idcontroller){
