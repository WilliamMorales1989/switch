...
public class DatosAprov {
	...
	public Date getTiempoIni() {
		return TiempoIni;
	}
	public void setTiempoIni(Date tiempoIni) {
		TiempoIni = tiempoIni;
	}
	...
	public String getIterstitial() {
		return Iterstitial;
	}
	public void setIterstitial(String iterstitial) {
		Iterstitial = iterstitial;
	}
